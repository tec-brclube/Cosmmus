...
export const teamMembers: TeamMember[] = [
  {
    ...
    credentials: [
      ...
      'Prêmio de Cultura e Extensão da Universidade Federal de Goiás (2016)',
  ...
  },
  {
    ...
    credentials: ['Economia pela Universidade Federal de Goiás (UFG)'],
  },
  {
